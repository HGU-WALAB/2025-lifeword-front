        ...
        if (
          ...
          response = response.filter((sermon) => {
            const worshipTypeMatch =
              filters.worshipTypes.length === 0 ||
              filters.worshipTypes.includes(sermon.worshipType);
              ...
              filters.bibleBooks.some(
                (book) =>
                  ...
                  (sermon.additionalScripture &&
                    sermon.additionalScripture.includes(book))
              );
            // 날짜 필터 적용
            let dateMatch = true;
    ...
    setFilters((prev) => {
      ...
      if (type === "worshipTypes") {
        if (newFilters.worshipTypes.includes(value)) {
          newFilters.worshipTypes = newFilters.worshipTypes.filter(
            (item) => item !== value
          );
        } else {
        ...
        if (newFilters.bibleBooks.includes(value)) {
          newFilters.bibleBooks = newFilters.bibleBooks.filter(
            (item) => item !== value
          );
        } else {
          ...
          <FilterAccordion>
            <FilterItem>
              ...
              >
                ...
                <ChevronDown
                  size={20}
                  style={{
                    transform: expandedFilters.bible
                      ? "rotate(180deg)"
                      : "rotate(0)",
            ...
            <FilterItem>
              ...
              >
                ...
                <ChevronDown
                  size={20}
                  style={{
                    transform: expandedFilters.worship
                      ? "rotate(180deg)"
                      : "rotate(0)",
                    transition: "transform 0.3s ease",
                  }}
            ...
            <FilterItem>
              <FilterItemHeader
                ...
                isExpanded={expandedFilters.date}
              >
                <span>날짜 기간</span>
                <ChevronDown
                  size={20}
                  style={{
                    transform: expandedFilters.date
                      ? "rotate(180deg)"
                      : "rotate(0)",
                    transition: "transform 0.3s ease",
                  }}
            ...
            <ActiveFilters>
              {filters.bibleBooks.map((book) => (
                <FilterTag key={book}>
                  ...
                  <RemoveButton
                    onClick={() => removeFilter("bibleBooks", book)}
                  >
                    ×
                  </RemoveButton>
                </FilterTag>
              ...
              {filters.worshipTypes.map((type) => (
                <FilterTag key={type}>
                  ...
                  <RemoveButton
                    onClick={() => removeFilter("worshipTypes", type)}
                  >
                    ×
                  </RemoveButton>
                </FilterTag>
              ...
              {filters.dateFilter && (
                <FilterTag>
                  ...
                  <RemoveButton onClick={() => removeFilter("dateFilter")}>
                    ×
                  </RemoveButton>
                </FilterTag>
              )}
...
const ContentWrapper = styled.div`
  ...
  grid-template-columns: ${(props) =>
    props.isNavExpanded ? "300px 1fr" : "260px 1fr"};
  gap: 40px;
...
const TabButton = styled.button`
  ...
  box-shadow: ${(props) =>
    props.active
      ? "0 4px 12px rgba(107, 78, 230, 0.2)"
